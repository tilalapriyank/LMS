export const security = [
    {
      ...
      description: "Define the password policy for user accounts (e.g., minimum length, special characters).",
      type: "group",
      fields: [
        {
    ...
    },
    {
      ...
      description: "Set the maximum number of failed login attempts before locking the account.",
      type: "number",
      value: 5, 
    },
    {
    ...
    },
    {
      ...
      description: "Set the duration (in minutes) for account lockout after exceeding the allowed number of login attempts.",
      type: "number",
      value: 15, 
    },
    {
      ...
      description: "Set the period (in days) after which users must change their password.",
      type: "number",
      value: 90, 
    },
    {
      ...
      description: "Enable or disable password history tracking to prevent users from reusing old passwords.",
      type: "switch",
      value: true, 
    },
    {
      ...
      description: "Enable or disable SSL encryption for all sensitive data transmissions.",
      type: "switch",
      value: true, 
    },
    {
